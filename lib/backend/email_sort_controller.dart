...
class EmailSortController {
  ...
  EmailSortController({required EmailSorter emailSorter})
      : _emailSorter = emailSorter;

  Future<List<Map<String, dynamic>>> categorizeEmailsList(
      List<Map<String, String>> emails) async {
    List<Map<String, dynamic>> categorizedEmails = [];

    for (var email in emails) {
      String emailText = _emailSorter.truncateText(
